...
const stages = [
  {
    ...
    after: "구매자 및 공급사 양방향 온보딩 프로세스 구축",
  },
  {
    no: "02",
    title: "상품",
    before: "자사가 등록하면 곧 판매라 별도 승인 개념 없음",
    after: "등록-승인-노출 단계별 검수 프로세스 및 판매 자격 기준 신설",
  },
  {
    no: "03",
    title: "주문 · 결제",
    before: "자사 상품 단일 판매로 단일 주문·결제 흐름",
    after: "다중 공급사·다중 배송지 주문 구조 설계 및 결제·자금 흐름 분리",
  },
  {
    no: "04",
    title: "배송 · 클레임",
    before: "자사가 직접 출고 및 CS를 전담하는 단일 책임 구조",
    after: "공급사별 발주·출고 및 부분 취소·클레임 처리 정책 수립",
  },
  {
    no: "05",
    title: "정산",
    before: "자사 매출로 마감되어 별도 정산 개념 없음",
    after: "3P 정산 산정, 중개 수수료 분리 및 세무 증빙 기준 수립",
  },
];
  ...
  return (
    <div className="exp-scope-wrap">
      <p className="exp-scope__lead text-body">
        자사 직접 판매와 공급사 입점 판매가 한 플랫폼에서 운영되며 판매와 책임 주체가
        달라지는 문제를 해결해야 했습니다. 이를 위해 회원가입부터 정산까지 커머스 전 영역의
        흐름을 주체 기준으로 재설계했습니다.
      </p>
