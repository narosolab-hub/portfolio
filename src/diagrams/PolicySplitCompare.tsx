...
const columns = [
  {
    ...
    note: "핵심 거래처 이탈 방지를 위해 자사(1P) 상품에 한정하여 제한적 후불결제 유지",
  },
  {
    key: "3p",
    ...
    note: "전자금융거래법 위반 방지를 위한 3P 전용 PG 결제 및 지급 대행 구조 도입",
  },
];
...
const conflicts = [
  {
    who: "경영진 / 거래처",
    wants: [
      { label: "경영진", lines: ["불확실한 외상 거래를 줄이되 PG 수수료 최소화"] },
      { label: "거래처", lines: ["상품마다 무통장입금으로 결제하는 번거로움 최소화"] },
    ],
    decision: "1P·3P 특성 차이로 단일 선불 결제 통합 불가 → 자사 상품 한정 후불결제 유지",
  },
  {
    who: "운영팀 / 재무팀",
    wants: [
    ...
    decision: "기존 거래처를 그대로 이전하고 반복되던 수기 정산 업무를 자동화해 운영·재무 부담 최소화",
  },
  {
    who: "법적 리스크",
    wants: [
    ...
    decision: "전자금융거래법 위반 방지를 위해 3P 판매대금은 PG 지급대행 구조로 분리하여 직접 수취 차단",
  },
];
