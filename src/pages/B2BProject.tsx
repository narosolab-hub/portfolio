  ...
  return (
    <div>
      ...
      <Tile
        ...
        subcopy="앞서 1P와 3P의 결제·정산 기준은 나눈 후에는 매출 신고에 대한 문제가 있었습니다. PG 계약은 자사 명의로 진행되어 국세청 매출 신고는 자사 사업자를 기준으로 잡혔습니다. 때문에 3P 판매대금 전체가 자사 매출이 아니라 공급사에게 정산해야 할 금액과 자사 수수료 매출로 나뉜다는 점을 소명해야 했습니다. 이 부분은 기존 1P 직접 판매 정산만 해오던 재무팀에도 새로운 영역이라 현재 재무팀과 협의하며 전문 회계 검토가 필요한 과제로 정리하고 있습니다."
