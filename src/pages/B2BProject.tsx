  ...
  return (
    <div>
      ...
      <Tile
        ...
        subcopy="연 24억·거래처 약 340개 규모의 B2B 폐쇄몰 리뉴얼로 시작했지만 요구사항을 정리해보니 단순 리뉴얼이 아니었습니다. 공급사가 입점하고, 외상 거래를 시스템화하고, 여러 배송지 주문을 한 번에 처리하고, 상품 등록 부담까지 줄여야 했습니다. 이에 1P와 3P 혼합 구조의 플랫폼으로 전환하는 프로젝트로 재정의하고, 회원·상품·주문·결제·정산 기준부터 잡았습니다."
