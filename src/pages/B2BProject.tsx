        ...
        subcopy={
          sec("e2e-qa").subcopy ?? (
            <>
              ...
              Phase 1·2로 명확한 Go-Live 기준을 세워 무리한 런칭으로 발생할 수 있는 운영 마비를 사전에
              차단했습니다.
            </>
          )
        }
        ...
        subcopy={
          sec("settlement-logic").subcopy ?? (
            <>
              ...
              리스크</strong>였습니다. 이를 해결하기 위해 개발사와 협의하여 화면 단위의 처리를 로직
              원칙으로 재정의한 <strong>'정산 3원칙'</strong>을 수립했습니다. 또한 내부 브랜드 전용
              할인이 전체 공급사에 일괄 적용되던 <strong>정책 공백</strong>을 발견해 필드 신설 및 로직
              수정을 완료했습니다.
            </>
          )
        }
        ...
        subcopy={
          sec("feature-improve").subcopy ?? (
            <>
              ...
              우선 기획했습니다. 구매자를 위한 <strong>품절 상품 재입고 SMS 자동 알림</strong>,
